...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->labelEditKontrahent->Text = L"Zestawienie samochodów";
			// 
			// ZestawienieSamochodowForm
			// 
...
#pragma endregion
	private: System::Void btnSzukaj_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		try
		{
			...
			String^ sqlString = "select s.Marka, s.Model, s.nr_rejestracyjny as 'Nr rejestracyjny', l.nazwa as 'Typ naczepy', sum(t.kilometry) as 'Przejechane km',sum(t.koszt_paliwa) as 'Koszty Paliwa', sum(z.naleznosc) as Przychód, sum(z.naleznosc) - sum(t.koszt_paliwa) as Zysk  " +
